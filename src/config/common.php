 ...
 * Содержит регистрацию модуля. Меню (adminMenu) и опции остаются вкладами modman/config. Значения
 * берутся из статических методов {@see Module} — единый источник, без дублирования.
 */
return [
    'modules' => [
